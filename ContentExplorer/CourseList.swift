...
//  ContentExplorer
//
//  Created by Sebastian on 13/06/20.
    ...
    var body: some View {
        ZStack(alignment: .top) {
            VStack(alignment: .leading, spacing: 30.0) {
                Text("Take your SwiftUI app to the App Store with advanced techniques likes API data, packages and CMS.")
...
var coursesData = [
    ...
    Course(title: "UI Design for Developers", subtitle: "22 Sections", image: #imageLiteral(resourceName: "Card4"), logo: #imageLiteral(resourceName: "Logo3"), color: #colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1), show: false)
]
